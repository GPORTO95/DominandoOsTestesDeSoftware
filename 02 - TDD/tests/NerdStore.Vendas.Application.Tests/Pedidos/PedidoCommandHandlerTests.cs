...
namespace NerdStore.Vendas.Application.Tests.Pedidos
{
    public class PedidoCommandHandlerTests
    {
        ...
        public async Task AdicionarItem_NovoPedido_DeveExecutarComSucesso()
        {
            ...
            // Act
            var result = await _pedidoHandler.Handle(command, CancellationToken.None);
        ...
        {
            // Arrange
            var pedidoExistente = new PedidoItem(Guid.NewGuid(), "Produto Xpto", 2, 100);
            _pedido.AdicionarItem(pedidoExistente);

            var command = new AdicionarItemPedidoCommand(_clienteId, Guid.NewGuid(),
                "Produto Teste", 2, 100);
        ...
        public async Task AdicionarItem_ItemExistenteAoPedidoRascunho_DeveExecutarComSucesso()
        {
            ...
            var command = new AdicionarItemPedidoCommand(_clienteId, _produtoId, "Produto Xpto", 2, 100);
