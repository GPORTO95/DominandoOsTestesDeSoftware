...
namespace NerdStore.Vendas.Application.Tests.Pedidos
{
    public class PedidoCommandHandlerTests
    {
        ...
        public async Task AdicionarItem_NovoPedido_DeveExecutarComSucesso()
        {
            ...
            // Act
            var result = await pedidoHandler.Handle(command, CancellationToken.None);
        ...
        public async Task AdicionarItem_NovoItemAoPedidoRascunho_DeveExecutarComSucesso()
        {
            ...
            pedido.AdicionarItem(pedidoExistente);

            var command = new AdicionarItemPedidoCommand(clienteId, Guid.NewGuid(),
                "Produto Teste", 2, 100);
        ...
        public async Task AdicionarItem_ItemExistenteAoPedidoRascunho_DeveExecutarComSucesso()
        {
            ...
            var command = new AdicionarItemPedidoCommand(clienteId, produtoId, "Produto Xpto", 2, 100);
